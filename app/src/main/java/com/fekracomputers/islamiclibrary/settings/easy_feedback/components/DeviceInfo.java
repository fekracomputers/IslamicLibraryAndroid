package com.fekracomputers.islamiclibrary.settings.easy_feedback.components;
...
import static com.fekracomputers.islamiclibrary.settings.easy_feedback.components.DeviceInfo.Device.DEVICE_LANGUAGE;
